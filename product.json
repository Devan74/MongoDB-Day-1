...
db.product.find({ product_price: { $gt: 500} }).pretty().limit(4);
// 5.Find the product name and product material of each products
db.product.find({},{product_name:1,product_material:1}).pretty()
// 6.Find the product with a row id of 10
db.product.find({ id: { $regex: /10/ } }).pretty();
// 7.Find only the product name and product 
...
// 10.Delete the products which product price value are same
  ...
  db.product.deleteOne({ id: "24" });
  
  db.product.deleteOne({ id: "20" });